...
function renderBody(workDays, todayISO) {
  ...
  people.forEach(person => {
    ...
    tdName.innerHTML = `
      <button class="person-btn" data-person="${escHtml(person)}" title="Modifier le vote de ${escHtml(person)}">
        <span class="person-avatar" style="background:${color}">${initials}</span>
        <span class="person-name-full">${escHtml(person)}</span>
        <span class="person-name-initials">${initials}</span>
      </button>`;
